    ...
    $(function() {
        ...
        $.validator && $.validator.config({
            ...
            rules: {
                ...
                //自定义方法：验证input输入 2017年4月8日21:40:18
                , maxSize: function (element, params) {
                    if (!params) return true
                    var maxL = parseInt(params[0]);
                    if (element.value.trim().length>maxL) {
                        return this.renderMsg('请最多输入{1}个字符！', params);
                    }
                }
